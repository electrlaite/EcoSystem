...
// Import utilities
import {formatValue, formatValueUnit} from '../utils/Utils';
...
function LineChart01({
        ...
        plugins: {
          tooltip: {
            callbacks: {
              ...
              label: (context) => dollars ? formatValue(context.parsed.y) : formatValueUnit(context.parsed.y),
            },
  ...
  useEffect(() => {
    if (chart) {
      chart.data = data; // Mettre à jour les données du graphique
      chart.update('none'); // Mettre à jour le graphique
    }
  }, [data]); // Ajouter data comme dépendance
